...
export const PERSONAS: Record<string, PersonaData> = {
  marcus: {
    ...
    character_name: 'The Challenger',
    tier: 'Flex',
    score: 142,
    quote: "I don't back down. But I'm learning when to walk away.",
    trap: 'Temper + Loyalty to friends',
    avatar: 'MC',
    color: '#DC2626',
  },
  aaliyah: {
    ...
    city: 'Chicago, IL',
    character: 'navigator',
    character_name: 'The Navigator',
    tier: 'Vetted',
    score: 287,
    quote: "I map the moves before I make them. Strategy is survival.",
    trap: 'Overthinking + Pressure to be perfect',
    avatar: 'AN',
    color: '#00A8E8',
  },
  jordan: {
    ...
    character_name: 'The Straight Shooter',
    tier: 'Watch',
    score: 67,
    quote: "I say what I mean. Sometimes too loud, but always real.",
    trap: 'Home instability + Acting out',
    avatar: 'JS',
    color: '#10B981',
  },
  deshawn: {
    ...
    tier: 'Flex',
    score: 175,
    quote: "I seen enough to know the game. Now I play it different.",
    trap: 'Boredom + Old habits',
    avatar: 'DS',
    color: '#6C5CE7',
  },
  kaya: {
    ...
    tier: 'Watch',
    score: 89,
    quote: "I'm still figuring it out. But I show up. That counts.",
    trap: "Don't know yet — still exploring",
    avatar: 'KN',
    color: '#00A8E8',
  },
}
